...
router.get("/getMoneyDetails", (0, auth_1.verifyTokenWithRole)("user"), dependencyInjection_1.userController.getMoneyDetails);
...
router.post("/removeStockFromWatchlist", (0, auth_1.verifyTokenWithRole)("user"), dependencyInjection_1.userController.removeStockFromWathclist);
...
router.get("/imagekit/auth", (0, auth_1.verifyTokenWithRole)("user"), dependencyInjection_1.userController.getAuthParams);
router.post("/upload", upload.single("file"), (0, auth_1.verifyTokenWithRole)("user"), dependencyInjection_1.userController.uploadFile);
